...
| `/products` | New (replaces `/solutions`) | PageHero · ProductShowcase · two product rows · CTA |
| `/products/smartchama` | New | PageHero · problem · features · how it works · phone UI · integrations · CTA |
| `/products/gikuyu-translator` | New | Same structure with translator UI |
...
1. Which numbers are real (businesses served, results)? Any shareable case studies?
2. Real testimonials with permission?
3. Status of SmartChama and the Gikuyu Translator (live / pilot / in development)?
4. KES pricing, or keep USD?
5. Team photos for Eric, Lenny and Racheal.
6. A real X/Twitter handle, or remove it?
7. Google Search Console verification code.
8. Who is the data controller for the privacy policy (registered company name and address)?
