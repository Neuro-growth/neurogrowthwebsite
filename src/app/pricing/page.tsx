            ...
            <RevealOnScroll delay={80}>
              <div style={{ ...cardStyle, border: '1px solid #00D4FF', boxShadow: '0 0 40px rgba(0,212,255,0.12)', background: 'linear-gradient(135deg, rgba(10,10,10,0.95) 0%, rgba(100,255,218,0.03) 100%)', position: 'relative' }}>
                <div style={{
                  ...
                  background: 'linear-gradient(135deg, #00a83a 0%, #008c2e 40%, #007025 100%)', color: '#fff', fontSize: 12, fontWeight: 700,
...
const cardStyle: React.CSSProperties = { background: 'transparent', border: 'none', borderRadius: 20, padding: '44px 36px' }
...
const btnPrimary: React.CSSProperties = { display: 'flex', justifyContent: 'center', padding: '14px 0', background: 'linear-gradient(135deg, #00a83a 0%, #008c2e 40%, #007025 100%)', color: '#fff', fontWeight: 700, fontSize: 15, borderRadius: 999, textDecoration: 'none', fontFamily: 'var(--font-space), sans-serif', width: '100%' }
const btnOutline: React.CSSProperties = { display: 'flex', justifyContent: 'center', padding: '14px 0', background: 'transparent', color: '#fff', fontWeight: 600, fontSize: 15, border: '1.5px solid rgba(0,160,55,0.50)', borderRadius: 999, textDecoration: 'none', fontFamily: 'var(--font-space), sans-serif', width: '100%' }
