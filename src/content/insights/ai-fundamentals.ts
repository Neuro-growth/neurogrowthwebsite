...
export const aiFundamentalsArticle: Article = {
  ...
  body: [
    ...
    {
      type: "h2",
      id: "how-does-ai-actually-work",
      text: "How Does AI Actually Work?",
    },
    {
      type: "p",
      text: 'At its core, AI works by finding patterns in large amounts of data. You feed the system examples — thousands or millions of them — and it learns the relationships between inputs and outputs. For example, you show it 10,000 emails labelled "spam" or "not spam" and it learns to predict which new emails are spam. This process is called Machine Learning. The more quality data you give it, the more accurate and useful it becomes. Modern AI like ChatGPT is trained on billions of text examples, which is why it can have human-like conversations.',
    },
    {
      type: "h2",
      id: "how-can-ai-help-your-business",
      text: "How Can AI Help Your Business?",
    },
    {
      type: "p",
      text: "AI can help your business in four main ways: Automation — doing repetitive tasks faster and more accurately than humans (sending emails, categorising support tickets, updating records). Intelligence — turning your data into insights you can act on (which customers are about to leave, which products will sell best next month). Personalisation — giving every customer a tailored experience at scale (product recommendations, personalised messages, custom pricing). Speed — doing in seconds what would take your team hours or days.",
    },
    {
      type: "h2",
      id: "ai-in-the-african-business-context",
      text: "AI in the African Business Context",
    },
    {
      type: "p",
      text: "AI is not just for Silicon Valley. African businesses are already using AI to solve uniquely African problems — from M-Pesa fraud detection to crop yield prediction in agriculture, to multilingual customer support across 50+ languages. The opportunity for African businesses is enormous. Labour costs are rising. Competition is increasing. Customers expect faster, more personalised service. AI allows you to do more with less, compete with larger companies, and serve your customers better — regardless of your business size.",
    },
    {
      type: "h2",
